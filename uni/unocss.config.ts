...
export default {
    ...
    shortcuts: [
        ["container", "relative z-10 flex flex-col w-full mx-auto py-32rpx px-26rpx gap-3 text-slate-800"],
    ...
    transformers: [transformerDirectives({ enforce: "pre" }), transformerAttributify(), transformerClass()],
};
