...
class Token extends Controller
{
    ...
    {
        MiniUserToken::mQuery()->layTable(function () {
            $this->title = '登录设备';
    ...
    public function remove(): void
    {
        ...
        MiniUserToken::mk()->where(['token' => $token])->update(['status' => 0]);
    ...
    public function destroy(): void
    {
        ...
        MiniUserToken::mk()->where(['user_id' => $userId])->delete();
