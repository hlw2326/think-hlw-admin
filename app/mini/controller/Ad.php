...
class Ad extends Controller
{
    ...
    {
        $mpList = MiniMp::mk()->where('status', 1)->column('name', 'appid');
        ...
        $total = MiniAd::mk()->group('appid')->column('count(id) as cnt,appid', 'appid');
        ...
        MiniAd::mQuery()->layTable(function () use ($tabs) {
            $this->title    = '广告列表';
